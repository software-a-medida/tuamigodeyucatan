        ...
        <div class="pos-absolute d-flex align-items-center p-20 p-md-40" style="top:0px;right:0px;bottom:0px;left:0px;background-color:rgba(0,0,0,0.4);">
            <div class="container">
                ...
                <div class="d-flex justify-content-center">
                    <a href="/reserva-ahora/rio-lagartos" class="btn" style="width:100%;max-width:200px;">{$lang.book_now}</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        <a href="/reserva-ahora/rio-lagartos" class="btn btn-block">{$lang.book_now}</a>
                    </div>
                </div>
            </div>
        </div>
